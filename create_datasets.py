...
URLS = {
    ...
    'mnist': 'http://storage.googleapis.com/cvdf-datasets/mnist/{}.gz',
}
...
def _load_svhn():
    ...
    for split in ['train', 'test', 'extra']:
        with open("ae_data/{}_32x32.mat".format(split), "rb") as f:
            # urllib.request.urlretrieve(URLS['svhn'].format(split), f.name, show_progress)
...
def _load_celeba():
    with open("ae_data/celeba.zip", "rb") as f:
